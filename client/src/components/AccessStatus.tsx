...
export default function AccessStatus({ status }: AccessStatusProps) {
  ...
  if (status === "rejected") {
    return (
      <div className="min-h-screen blueprint-grid flex items-center justify-center p-4">
        ...
        <div className="relative z-10 max-w-md w-full">
          {/* Corner brackets */}
          <div className="absolute -top-4 -left-4 w-8 h-8 border-t-2 border-l-2 border-[#ef5350] [border-color:rgba(30,144,255,0.6)]"></div>
          <div className="absolute -top-4 -right-4 w-8 h-8 border-t-2 border-r-2 border-[#ef5350] [border-color:rgba(30,144,255,0.6)]"></div>
          <div className="absolute -bottom-4 -left-4 w-8 h-8 border-b-2 border-l-2 border-[#ef5350] [border-color:rgba(30,144,255,0.6)]"></div>
          <div className="absolute -bottom-4 -right-4 w-8 h-8 border-b-2 border-r-2 border-[#ef5350] [border-color:rgba(30,144,255,0.6)]"></div>

          {/* Main card */}
          <div className="blueprint-card p-8 space-y-8 border-[#ef5350] [border-color:rgba(30,144,255,0.4)]">
            {/* Header */}
            <div className="text-center space-y-4">
              <div className="flex justify-center">
                <div className="w-16 h-16 border-2 border-[#ef5350] [border-color:rgba(30,144,255,0.6)] flex items-center justify-center">
                  <div className="text-2xl">✕</div>
                </div>
              </div>
              <h1 className="blueprint-section-title text-2xl text-[#ef5350]">ACCESS DENIED</h1>
              <div className="blueprint-divider"></div>
            </div>
            ...
            <div className="space-y-4 text-center">
              <p className="text-gray-300 text-sm leading-relaxed">
                Your access request to the HIV Paeds CHK system has been denied by the system administrator.
              </p>
              <div className="bg-[#0a1628] border border-[#ef5350] [border-color:rgba(var(--border),0.3)] rounded-sm p-4">
                <p className="text-[#ef5350] text-xs tracking-widest font-bold mb-2">[ ACCESS DENIED ]</p>
                <p className="text-gray-400 text-sm">
                  If you believe this is an error or have questions about your access, please contact the system administrator.
                </p>
              </div>
            </div>
